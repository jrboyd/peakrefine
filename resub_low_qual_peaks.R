library(magrittr)
pipe_output = "/slipstream/home/joeboyd/R/peakrefine/simulation/genomes/simGenome10M_v3/output"
...
for(treat_bam in all_bams[!grepl("input", all_bams)]){
    ...
    cmd = sub("NAME", paste0(sub(".bam", "", basename(treat_bam)), "_superLoose"), cmd)
